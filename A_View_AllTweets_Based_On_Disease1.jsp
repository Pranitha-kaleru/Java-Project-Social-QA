...
<head>
<title>View Tweets Based on disease</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p class="style2">Capture and View Different Health Monitoring for <span class="style6">::<span class="style7"> <%=(String)request.getParameter("disease")%> :: </span></span> Disease...</p>
        <p class="style2">&nbsp;</p>
	...
	String query="select * from tweets where tname='"+disease+"'"; 
